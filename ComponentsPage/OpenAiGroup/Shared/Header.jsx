...
const Header = ({ navigation: { name = "aaaa", link = "/" } }) => {
  // let { name = "Text Completion", link = "/generate-text" } = navigation;
  return (
    <div className=" openai-header fixed-top">
      <div className=" container h-100 center ">
        <div className="  d-flex justify-content-between w-100">
          ...
          <div className=" d-flex gap-2 gap-md-4 ">
            <Link href={link} className=" link-undecorated">
              <div className="h5 m-0 cursor-pointer">{name}</div>
            </Link>
          </div>
        </div>
      </div>
